...
yqvm.toolsFunc.defineProperty(location, "href", {configurable:false, enumerable:true, get:function (){return yqvm.toolsFunc.dispatch(this, location, "location", "href_get", arguments, 'https://www.nmpa.gov.cn/')}, set:function (){return yqvm.toolsFunc.dispatch(this, location, "location", "href_set", arguments)}});
yqvm.toolsFunc.defineProperty(location, "origin", {configurable:false, enumerable:true, get:function (){return yqvm.toolsFunc.dispatch(this, location, "location", "origin_get", arguments, 'https://www.nmpa.gov.cn')}, set:undefined});
...
yqvm.toolsFunc.defineProperty(location, "host", {configurable:false, enumerable:true, get:function (){return yqvm.toolsFunc.dispatch(this, location, "location", "host_get", arguments, 'www.nmpa.gov.cn')}, set:function (){return yqvm.toolsFunc.dispatch(this, location, "location", "host_set", arguments)}});
yqvm.toolsFunc.defineProperty(location, "hostname", {configurable:false, enumerable:true, get:function (){return yqvm.toolsFunc.dispatch(this, location, "location", "hostname_get", arguments, 'www.nmpa.gov.cn')}, set:function (){return yqvm.toolsFunc.dispatch(this, location, "location", "hostname_set", arguments)}});
