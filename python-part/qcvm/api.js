...
(function() {
        ...
        var St = function(e) {
            var t, a, o = window.innerWidth < 400, c = e.state !== ve.FailureFeedbackCode && (e.state === ve.FailureFeedback || e.state === ve.FailureHavingTroubles || !e.errorCode), l, v = L(Mr, (l = (t = e.displayLanguage) === null || t === void 0 ? void 0 : t.toLowerCase()) !== null && l !== void 0 ? l : "nonexistent"), h, s = L(Lr, (h = (a = e.displayLanguage) === null || a === void 0 ? void 0 : a.toLowerCase()) !== null && h !== void 0 ? h : "nonexistent");
            return o ? Fr({
        ...
        function Wr(e) {
            ...
            try {
                for (var c = e.widgetMap[Symbol.iterator](), l; !(t = (l = c.next()).done); t = !0) {
                    var v = Ce(l.value, 2), h = v[0], s = v[1], p;
            ...
            var e = function(n, i, r, u) {
                ...
                if (u) {
                    ...
                    u.isResetting = !0,
                        ...
                        u.watchcat.seq = 0,
                    u.params.execution === ge.Render && (u.msgQueue.push(ue.Execute),
                        u.isExecuted = !0,
                        u.isExecuting = !0);
                    var m = $(r)
                ...
                var V = qr(m);
                if (V) {
                    var f = Object.assign(V, i), _e = f.action, re = f.cData, ke = f.chlPageData, H = f.sitekey, ae;
                    ...
                    dt(_e) || g('Invalid input for optional parameter "action", got "'.concat(_e, '"'), 3604),
                    ...
                    if (!(!Ie || !pe)) {
                        ...
                        et || g("Turnstile Initialization Error ", 3606),
                            ...
                            j.setAttribute("src", Rt(Ie, H, f, K, !1, "b", z.New, _t(et))),
                            j.onerror = function() {
                                if (Y) {
                        ...
                        if (!(!i || !r))
                            switch (n.event) {
                                ...
                                case "fail":
                                {
                                    ...
                                    if (D) {
                                        var f;
                                        D(String((f = n.code) !== null && f !== void 0 ? f : Qt)) ? r.params.retry === me.Auto && !r.isResetting && t(r, i, B) : (n.code && x("Error: ".concat(n.code, ".")),
                                            t(r, i, B))
                                    } else
                                        n.code ? (t(r, i, B),
                                ...
                                case "closeFeedbackReportIframe":
                                {
                                    ...
                                    be || g("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                        vr("".concat(i, "-fr"));
                                    break
                                }
                                case "tokenExpired":
                                {
                                    var ie, xe = n.token;
                                    r.isExpired = !0,
                                    (ie = r.cbExpired) === null || ie === void 0 || ie.call(r, xe),
        ...
        C != null && C.params && (he = C.params.get("compat"),
            (he == null ? void 0 : he.toLowerCase()) === "recaptcha" ? window.grecaptcha ? x("grecaptcha is already defined. The compatibility layer will not be enabled.") : (x("Compatibility layer enabled."),
                y.isRecaptchaCompatibilityMode = !0,
                window.grecaptcha = Dt) : he !== null && x('Unknown value for api.js?compat: "'.concat(he, '", ignoring.')),
            ...
            ye = C.params.get("_upgrade") === "true",
            G = C.params.get("onload"),
        G && !ye && setTimeout(function() {
            ...
            Lt && !ye ? x("Turnstile already has been loaded. Was Turnstile imported multiple times?") : (Lt && ye && (_r(window.turnstile, y),
                Ot(y),
            (C == null || (Ke = C.params) === null || Ke === void 0 ? void 0 : Ke.get("render")) !== "explicit" && setTimeout(Ft, 0)),
                window.turnstile = Dt,
            ye || ((C == null || ($e = C.params) === null || $e === void 0 ? void 0 : $e.get("render")) !== "explicit" && Pt.push(Ft),
